...
export function StepIntent({ selected, onSelect, projectName, onProjectNameChange }: StepIntentProps) {
    ...
    <div className="flex flex-col space-y-4">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full rounded-xl border border-input bg-background px-4 py-3 text-sm outline-none ring-offset-background placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        />
      </div>
